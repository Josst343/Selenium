...
public class LoginUsuarioTest {
	...
	private WebDriver driver;
	  ...
	  public void testUntitledTestCase() throws Exception {
	   ...
	   driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Autores'])[1]/following::button[1]")).click();
	    String UrlActual= driver.getCurrentUrl();
	    Assert.assertEquals("http://blog-curso.herokuapp.com/", UrlActual);
	  }
